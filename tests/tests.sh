...
# ../pipeline.py --fwd-reads-sig _F --rev-reads-sig _R --norm-k-list 31 --norm-cov-list 1,2,5,10 --asm-k-list 21,33,55,77 --reads-dir data_small --threads 12 --est-ref-len 9678

# Fast agnostic HCV multisample with mapping
# ../pipeline.py --fwd-reads-sig _F --rev-reads-sig _R --norm-k-list 31 --norm-cov-list 1,2,5,10 --asm-k-list 21,33,55,77 --reads-dir data_small --threads 12 --reference /Users/Bede/Research/Datasets/ref_sequences/hcv/h77.fasta
...
../pipeline.py --fwd-reads-sig _F --rev-reads-sig _R --norm-k-list 19,25,31 --norm-cov-list 1,2,5,10,20 --asm-k-list 21,33,55,77 --reads-dir data --threads 12 --reference /Users/Bede/Research/Datasets/ref_sequences/hcv/h77.fasta
